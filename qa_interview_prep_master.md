...
|-----------|--------|--------|
| 01_testing_theory | 9 | ⬜ Не начато |
| 02_java_for_qa | 12 | ⬜ Не начато |
| 03_test_frameworks | 5 | ⬜ Не начато |
| 04_ui_automation | 7 | ⬜ Не начато |
| 05_api_automation | 6 | ⬜ Не начато |
| 06_framework_architecture | 7 | ⬜ Не начато |
| 07_reporting | 5 | ⬜ Не начато |
| 08_ci_cd_for_qa | 5 | ⬜ Не начато |
| 09_databases_for_qa | 5 | ⬜ Не начато |
| 10_architecture_for_qa | 8 | ⬜ Не начато |
| 11_testing_microservices | 4 | ⬜ Не начато |
| 12_processes_for_qa | 10 | ⬜ Не начато |
| 13_self_presentation | 4 | ⬜ Не начато |
| 14_design_patterns | 6 | ⬜ Не начато |
| 15_spring_for_qa | 5 | ⬜ Не начато |
| 16_git | 1 | ⬜ Не начато |
| 17_build_tools | 1 | ⬜ Не начато |
| 18_computer_science | 3 | ⬜ Не начато |
| 19_common_problems | 5 | ⬜ Не начато |
| 20_performance_security | 3 | ⬜ Не начато |
| 21_ai_in_testing | 2 | ⬜ Не начато |
| **Итого** | **112 файлов** | |
